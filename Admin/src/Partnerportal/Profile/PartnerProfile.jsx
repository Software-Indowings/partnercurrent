        ...
        <div className='d-flex flex-column vh-100 justify-content-center align-items-center'>
            <div className='w-75 bg-white rounded p-5'>
                ...
                <div style={{ marginBottom: '20px' }}>
                        <strong><label htmlFor="">Registered E-mail:  </label> </strong>
                        {user && user.username ? user.username : "Guest"}
                    </div>
                    <div style={{ marginBottom: '20px' }}>
                        <strong><label htmlFor="">Registered Category:  </label> </strong>
                        {user.category}
                    </div>
                            ...
                            <table className="table table-bordered" key={index}>
                                <tbody>
                                    ...
                                    <tr>
                                        <th> Key Contacts</th>
                                        <td>
                                            Name: {partners_profile.key_name}<br />
                                            Email: {partners_profile.key_email}<br />
                                            Phone: {partners_profile.key_phone}<br />
                ...
                <div className="mt-4">
                    <Link to="/layout" className='btn btn-primary me-2'>Back</Link>
                </div>
            </div>
        </div>
    );
