  ...
  return (
    <div style={{ 
      ...
      <MDBContainer className="my-5" style={{ padding: "5px" }}>
        <MDBCard style={{ border: "2px solid orange", width: "100%", backgroundColor: "white" }}>
          <MDBRow className='g-0'>
            <MDBCol md='6'>
              <MDBCardImage src={img} alt="login form" className='rounded-start' style={{ width: '100%', height: '100%' }} />
            </MDBCol>
            <MDBCol md='6'>
              <MDBCardBody className='d-flex flex-column align-items-center'>
                ...
                <form onSubmit={handleSubmit} style={{ width: "80%" }}>
                  <div style={{ marginBottom: "30px" }}>
                    <label style={{ display: "block", marginBottom: "10px", fontSize: "19px", fontFamily: 'Arial, sans-serif', color: 'black' }} htmlFor="username">Email</label>
                    <MDBInput
                      wrapperClass='mb-6'
                      id='username'
                      type='email'
                      ...
                      required
                      style={{ fontSize: '29px', fontFamily: 'Arial, sans-serif', color: 'black' }}
                    />
                  </div>
                  <div style={{ marginBottom: "20px" }}>
                    <label style={{ display: "block", marginBottom: "10px", fontSize: "19px", fontFamily: 'Arial, sans-serif', color: 'black' }} htmlFor="password">Password</label>
                    <MDBInput
                      wrapperClass='mb-4'
                      id='password'
                      type='password'
                      ...
                      onChange={handleInputChange}
                      required
                      style={{ fontSize: '30px', fontFamily: 'Arial, sans-serif', color: 'black' }}
                    />
                  </div>
                  <MDBBtn className="mb-4 px-5" color='dark' size='lg' type="submit" style={{ width: '200px', minWidth: '200px', height: '50px' }}>Login</MDBBtn>
                </form>
              </MDBCardBody>
            </MDBCol>
          </MDBRow>
